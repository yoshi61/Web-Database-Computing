...
function authToServer(auth, callback) {
    ...
    friendsListReq.onreadystatechange = function() {
		...
		var labelBullet = document.createElement("li");
		labelBullet.className = "side-list-element";

		var headerText = document.createElement("h4");
		headerText.className = "friend-title";
		headerText.innerHTML = friend.name;

		labelBullet.appendChild(headerText)
		friendDiv.appendChild(labelBullet);
